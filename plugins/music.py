...
async def play(_, message: Message):
        ...
        for administrator in administrators:
            if administrator == message.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"**ᴘʟᴇᴀsᴇ ᴍᴀɴᴜᴀʟʟʏ ᴀᴅᴅ ᴀssɪsᴛᴀɴᴛ ᴏʀ ᴄᴏɴᴛᴀᴄᴛ [ʏᴏᴜᴛᴜʙᴇ ᴍᴜsɪᴄ](https://t.me/TG_BOT_DEVELOPERS)** ")
    try:
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://telegra.ph/file/b7a7cb01680e8e9e6b321.jpg"
        ...
        try:
            ...
            views = results[0]["views"]
            durl = url
            durl = durl.replace("youtube", "youtubepp", "Instagram")
